        ...
        <section>
            ...
            <div>
                <div>
                    <h3>Para você</h3>
                    <ul>
                        <li>Tenha cartões de todos os lugares credenciados possíveis ❤️</li>
                        <li>Chega de perder seus cartões ou esquecer de levá-los 😂</li>
                ...
                <div>
                    ...
                    <ul>
                        <li>🤝 Fidelize seus clientes com a recorrência-por-recompensa</li>
