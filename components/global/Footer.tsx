                ...
                <nav>
                    <ul>
                        ...
                        <li>
                            <ul>
                                <li>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" aria-label="Conheça nossa conta no X" role="img">
                                        <path fill="currentColor" d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584l-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932ZM17.61 20.644h2.039L6.486 3.24H4.298Z"/>
                                    </svg>
                                </li>
                                <li>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" aria-label="Conheça nossa conta no Instagram" role="img">
                                ...
                                <li>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" aria-label="Conheça nossa conta no E-mail" role="img">
                                        <g fill="none" stroke="currentColor" strokeWidth="1.5">
                                            <rect width="18.5" height="17" x="2.682" y="3.5" rx="4"/>
                                            <path strokeLinecap="round" strokeLinejoin="round" d="m2.729 7.59l7.205 4.13a3.956 3.956 0 0 0 3.975 0l7.225-4.13"/>
                                        </g>
                                    </svg>
                                </li>
                                <li>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 432 432" aria-label="Conheça nossa conta no WhatsApp" role="img">
                                ...
                                <li>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 432 432" aria-label="Conheça nossa conta no LinkedIn" role="img">
